    ...
    <>
      <div className={styles.bannerCategoryContainer}>
        ...
        <div className={styles.view}>
          <div onClick={() => setClick(2)} className={styles.double}>
            2
          </div>
          <div onClick={() => setClick(3)} className={styles.triple}>
            3
          </div>
        </div>
        <div
          className={cn({
            ...
            [styles.triple]: click == 3,
            [styles.double]: click == 2,
          })}
        >
              ...
              <Link key={index} href={`/detail/${x.productId}`}>
                <a className={styles.bannerCategoryItem}>
                  ...
                  <div className={styles.bannerCategoryPrices}>
                    ...
                    <span className={styles.bannerCategoryPrice}>
                      {x.price}
                    </span>
                  </div>
                </a>
